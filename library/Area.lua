...
function Area:CreateAreaPrefab(pos, size, worldId) end
...
function Area:CreateAreaRectByRange(posBeg, posEnd, btmp, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return boolean result
function Area:PosInArea(areaid, pos, worldId) end
...
function Area:GetAllObjsInAreaRange(posbeg, posend, objtype, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return integer[] objs 对象objid组
function Area:GetAllPlayersInAreaRange(posbeg, posend, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return integer[] objs 对象objid组
function Area:GetAllCreaturesInAreaRange(posbeg, posend, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return boolean result
function Area:FillBlockAreaRange(posbeg, posend, blockid, face, color, switch, filltype, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return boolean result
function Area:ClearAllBlockAreaRange(posbeg, posend, blockid, btriggerevent, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return boolean result
function Area:CloneAreaRange(posbeg, posend, deststartpos, itype, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return boolean result
function Area:ReplaceAreaRangeBlock(posbeg, posend, srcblockid, destblockid, face, inair, worldId) end
...
function Area:GetRandomAirPos(posbeg, posend, worldId) end
...
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return boolean result
function Area:CheckRangeCanPlace(posbeg, posend, blockid, worldId) end
...
function Area:GetRelativeActors(posbeg, posend, uin, relativing, actortype, worldId) end

---通过长度创建矩形区域
---@param pos PositionTable 中心位置
---@param lenx number X轴长度
---@param leny number Y轴长度
---@param lenz number Z轴长度
---@param worldId? integer 星球id(默认当前主机所在星球)
---@return integer areaid 区域ID
function Area:CreateAreaRectByLen(pos, lenx, leny, lenz, worldId) end